...
export default function Technology() {
  ...
  return (
    <main
      id="main"
      className="grid min-h-screen overflow-hidden bg-[url('/assets/technology/background-technology-mobile.jpg')] bg-cover bg-bottom bg-no-repeat pb-14 pt-[88px] text-white [grid-template-rows:min-content_1fr] sm:pt-32 md:bg-[url('/assets/technology/background-technology-tablet.jpg')] md:pt-32 lg:min-h-[900px] lg:bg-[url('/assets/technology/background-technology-desktop.jpg')] lg:pt-56"
    >
