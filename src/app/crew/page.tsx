...
export default function Crew() {
  ...
  return (
    <main
      id="main"
      className="grid min-h-screen bg-[url('/assets/crew/background-crew-mobile.jpg')]   bg-cover bg-center bg-no-repeat pt-[88px] text-white [grid-template-rows:min-content_1fr] sm:pt-32 md:bg-[url('/assets/crew/background-crew-tablet.jpg')] md:pl-[28.5px] md:pt-[136px] lg:h-screen lg:min-h-[900px] lg:bg-[url('/assets/crew/background-crew-desktop.jpg')] lg:pl-40 lg:pt-[212px]"
    >
