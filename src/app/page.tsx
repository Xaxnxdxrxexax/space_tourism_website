...
export default function HomePage() {
  return (
    <main
      id="main"
      className="grid min-h-screen overflow-hidden bg-[url('/assets/home/background-home-mobile.jpg')] bg-cover bg-bottom bg-no-repeat pt-28 text-white [grid-template-rows:min-content_1fr] md:bg-[url('/assets/home/background-home-tablet.jpg')] md:pt-52 lg:min-h-[900px] lg:bg-[url('/assets/home/background-home-desktop.jpg')] lg:pt-96"
    >
